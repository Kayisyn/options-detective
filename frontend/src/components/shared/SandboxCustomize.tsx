...
export function SandboxCustomize({ settings, accountValue }: {
  ...
  return (
    <div className="card-glass" data-testid="sandbox-customize">
      ...
      {open && (
        <div className="grid gap-4 border-t border-white/10 p-4 sm:grid-cols-2" data-testid="sandbox-settings-detail">
          {/* Commission */}
