...
contextBridge.exposeInMainWorld("optionsDetective", {
  ...
  authLogout: () => ipcRenderer.invoke("api:auth:logout"),
  authChangePassword: (body) => ipcRenderer.invoke("api:auth:change-password", body),
  authDeleteAccount: (body) => ipcRenderer.invoke("api:auth:delete-account", body),
  accountExport: () => ipcRenderer.invoke("api:account:export"),
  accountImport: (body) => ipcRenderer.invoke("api:account:import", body),
  accountClear: () => ipcRenderer.invoke("api:account:clear"),
  listTrash: () => ipcRenderer.invoke("api:journal:trash:list"),
  trashTrade: (id) => ipcRenderer.invoke("api:journal:trash", id),
  restoreTrade: (id) => ipcRenderer.invoke("api:journal:restore", id),
  trashAll: () => ipcRenderer.invoke("api:journal:trash-all"),
  restoreAllTrash: () => ipcRenderer.invoke("api:journal:restore-all"),
  purgeTrash: () => ipcRenderer.invoke("api:journal:purge-trash"),
